...
$GLOBALS['TL_LANG']['tl_workflow_step']['triggerWorkflow'][0] = 'Trigger workflow';
$GLOBALS['TL_LANG']['tl_workflow_step']['triggerWorkflow'][1] = 'Start another workflow. Finalizes this workflow.';
