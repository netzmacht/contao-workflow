...
$GLOBALS['TL_LANG']['tl_workflow_step']['triggerWf'][0]       = 'Trigger workflow';
$GLOBALS['TL_LANG']['tl_workflow_step']['triggerWf'][1]       = 'Start another workflow. Finalizes this workflow.';
